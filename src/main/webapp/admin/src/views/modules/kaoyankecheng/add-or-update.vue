  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="课程名称" prop="kechengmingcheng">
              <el-input v-model="ruleForm.kechengmingcheng" 
                placeholder="课程名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考研类型" prop="kaoyanleixing">
          <el-select v-model="ruleForm.kaoyanleixing" placeholder="请选择考研类型">
            <el-option
                v-for="(item,index) in kaoyanleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="考研类型" prop="kaoyanleixing">
	      <el-input v-model="ruleForm.kaoyanleixing"
                placeholder="考研类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='kaoyanleixing'){
            this.ruleForm.kaoyanleixing = obj[o];
	    this.ro.kaoyanleixing = true;
            continue;
          }
	            	            if(o=='tupian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kaoyankecheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaoyankechengCrossAddOrUpdateFlag = false;
                  this.parent.search();

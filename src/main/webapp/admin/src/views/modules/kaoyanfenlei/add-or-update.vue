<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考研类型" prop="kaoyanleixing">
          <el-input v-model="ruleForm.kaoyanleixing" 
              placeholder="考研类型" clearable  :readonly="ro.kaoyanleixing"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kaoyanfenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaoyanfenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
